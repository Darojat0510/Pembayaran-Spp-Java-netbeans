...
private void bersih(){
    ...
    private void simpan(){
        try{
            setKoneksi();
            String sql="insert into pengguna values('"+ idTF.getText() +"','" + namaTF.getText()+"','" + usernameTF.getText()
    ...
    try{
        setKoneksi();
            String sql="update pengguna set nama='"+namaTF.getText()+"',username='"+usernameTF.getText()+
            "',hakakses='"+aksesCB.getSelectedItem()+"' where idpengguna='"+idTF.getText()+"'";
            st.executeUpdate(sql);
            JOptionPane.showMessageDialog(null,"Edit data berhasil","SEKOLAH CITA CITA",JOptionPane.INFORMATION_MESSAGE);
        } 
        catch(Exception e){
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 185, -1, 20));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel4.setText("Id Penguna  :");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1, 30));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel5.setText("Nama            :");
        jPanel3.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 90, 30));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel6.setText("Username     :");
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 105, 90, 20));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("Password     :");
        jPanel3.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 145, -1, 20));

        idTF.setBorder(null);
        jPanel3.add(idTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, 390, 30));

        namaTF.setBorder(null);
        jPanel3.add(namaTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 440, 30));
        jPanel3.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 530, 10));
        jPanel3.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 530, 10));
        jPanel3.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 530, 10));
        jPanel3.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 530, 10));

        usernameTF.setBorder(null);
        jPanel3.add(usernameTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 440, 30));

        passTF.setBorder(null);
        jPanel3.add(passTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 440, 30));
        jPanel3.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 530, 10));
        ...
        jPanel3.add(hapusBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 220, 120, 40));
        ...
        jPanel3.add(tambahBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 120, 40));
        ...
        jPanel3.add(simpanBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 220, 120, 40));
        ...
        jPanel3.add(editBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 220, 120, 40));
        ...
        jPanel3.add(cariBT, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 20, -1, 30));

        aksesCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--PILIH HAK AKSES--", "TU", "KEUANGAN", "KEPALA SEKOLAH" }));
        jPanel3.add(aksesCB, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 440, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 560, 290));
    ...
    private void simpanBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanBTActionPerformed
        // TODO add your handling code here:
         if(idTF.getText().isEmpty() || namaTF.getText().isEmpty() || usernameTF.getText().isEmpty() ||
    ...
    private void cariBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariBTActionPerformed
        ...
        try {
            ...
            if (rs.next())
            {
                ...
                usernameTF.setText(rs.getString(3));
